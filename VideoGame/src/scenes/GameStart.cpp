...
namespace scenes
{
	GameStart::GameStart(game::Game* game)
		:Scene(game)
		,bufCount(0)
	{
		mIsRunning = true;
	...
	void GameStart::DispSentenceFromFile(int font, int color, int rw, int rh)
	{
		char r[64] = { 0 };
		if (bufCount != 0)
		{
